...
Page({
  ...
  bindBuy: function () {
      ...
      price = this.data.priceIndex[this.data.index2]*this.data.times[this.data.index3] ;
      price2 = this.data.priceIndex2[this.data.index2]*this.data.times[this.data.index3];
  ...
  onShareAppMessage: function () {
    return {
      title: app.globalData.confi.expertSharePage.title,
      path: app.globalData.confi.expertSharePage.path,
      imageUrl:app.globalData.confi.expertSharePage.imageUrl,
      success: function(res) {
        common.addShares()
      }
    }
