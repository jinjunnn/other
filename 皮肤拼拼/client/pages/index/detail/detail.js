...
Page({
  ...
  bindFullBuy(e){
          ...
          that.donate(this.data.product.attributes.groupSell,this.data.product.attributes.content,2) 
  },

  bindBuy(e){
          var that = this;
          common.addFormId(e.detail.formId)
          that.donate(1,this.data.product.attributes.content,1)     
  },
  ...
  saveOrder(mode,cost,product){
      ...
      .then(function (todo) {
        ...
        wx.navigateTo({
          url: '../groupOrder/groupOrder?objectId='+groupOrder.id+'&price='+cost
        })
      });
  },
